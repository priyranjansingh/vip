...
class Am_Currency {
    static $currencyList = array(
        ...
        'AUD' => array('name' => 'Australian Dollar', 'country' => array('AU', 'CX', 'CC', 'HM', 'KI', 'NR', 'NF', 'TV'), 'numcode' => 036, 'precision' => 2),
        ...
        'BRL' => array('name' => 'Brazilian Real', 'country' => array('BR'), 'numcode' => 986, 'precision' => 2),
        ...
        'CAD' => array('name' => 'Canadian Dollar', 'country' => array('CA'), 'numcode' => 124, 'precision' => 2),
        ...
        'CZK' => array('name' => 'Czech Koruna', 'country' => array('CZ'), 'numcode' => 203, 'precision' => 2),
        'DJF' => array('name' => 'Djibouti Franc', 'country' => array('DJ'), 'numcode' => 262, 'precision' => 0),
        'DKK' => array('name' => 'Danish Krone', 'country' => array('DK', 'FO', 'GL'), 'numcode' => 208, 'precision' => 2),
        ...
        'EUR' => array('name' => 'Euro', 'country' => array('ÅLAND ISLANDS', 'AD', 'AT', 'BE', 'CY', 'EE', 'EUROPEAN UNION ', 'FI', 'FR', 'GF', 'FRENCH SOUTHERN TERRITORIES', 'DE', 'GR', 'GP', 'HOLY SEE (VATICAN CITY STATE)', 'IE', 'IT', 'LU', 'MT', 'MQ', 'YT', 'MC', 'MONTENEGRO', 'NL', 'PT', 'RE', 'SAINT MARTIN', 'SAINT PIERRE AND MIQUELON', 'SAINT-BARTHÉLEMY', 'SM', 'SK', 'SI', 'ES', 'Vatican City State (HOLY SEE)'), 'numcode' => 978, 'precision' => 2),
        ...
        'GBP' => array('name' => 'Pound Sterling', 'country' => array('GUERNSEY', 'ISLE OF MAN', 'JERSEY', 'GB'), 'numcode' => 826, 'precision' => 2),
        ...
        'HKD' => array('name' => 'Hong Kong Dollar', 'country' => array('HONG KONG'), 'numcode' => 344, 'precision' => 2),
        ...
        'HUF' => array('name' => 'Forint', 'country' => array('HU'), 'numcode' => 348, 'precision' => 2),
        'IDR' => array('name' => 'Rupiah', 'country' => array('ID'), 'numcode' => 360, 'precision' => 2),
        ...
        'JPY' => array('name' => 'Yen', 'country' => array('JP'), 'numcode' => 392, 'precision' => 0),
        ...
        'MXN' => array('name' => 'Mexican Peso', 'country' => array('MX'), 'numcode' => 484, 'precision' => 2),
        'MXV' => array('name' => 'Mexican Unidad de Inversion (UDI)', 'country' => array('MX'), 'numcode' => 979, 'precision' => 2),
        'MYR' => array('name' => 'Malaysian Ringgit', 'country' => array('MY'), 'numcode' => 458, 'precision' => 2),
        ...
        'NOK' => array('name' => 'Norwegian Krone', 'country' => array('BV', 'NO', 'SJ'), 'numcode' => 578, 'precision' => 2),
        'NPR' => array('name' => 'Nepalese Rupee', 'country' => array('NP'), 'numcode' => 524, 'precision' => 2),
        'NZD' => array('name' => 'New Zealand Dollar', 'country' => array('CK', 'NZ', 'NU', 'PITCAIRN', 'TK'), 'numcode' => 554, 'precision' => 2),
        ...
        'PHP' => array('name' => 'Philippine Peso', 'country' => array('PH'), 'numcode' => 608, 'precision' => 2),
        'PKR' => array('name' => 'Pakistan Rupee', 'country' => array('PK'), 'numcode' => 586, 'precision' => 2),
        'PLN' => array('name' => 'Zloty', 'country' => array('PL'), 'numcode' => 985, 'precision' => 2),
        ...
        'SEK' => array('name' => 'Swedish Krona', 'country' => array('SE'), 'numcode' => 752, 'precision' => 2),
        'SGD' => array('name' => 'Singapore Dollar', 'country' => array('SG'), 'numcode' => 702, 'precision' => 2),
        ...
        'THB' => array('name' => 'Baht', 'country' => array('TH'), 'numcode' => 764, 'precision' => 2),
        ...
        'TRY' => array('name' => 'Turkish Lira', 'country' => array('TR'), 'numcode' => 949, 'precision' => 2),
        'TTD' => array('name' => 'Trinidad and Tobago Dollar', 'country' => array('TT'), 'numcode' => 780, 'precision' => 2),
        'TWD' => array('name' => 'New Taiwan Dollar', 'country' => array('TAIWAN, PROVINCE OF CHINA'), 'numcode' => 901, 'precision' => 2),
        ...
        'USD' => array('name' => 'US Dollar', 'country' => array('AS', 'BONAIRE, SINT EUSTATIUS AND SABA', 'IO', 'EC', 'SV', 'GU', 'HT', 'MH', 'MICRONESIA, FEDERATED STATES OF', 'MP', 'PW', 'PA', 'PR', 'TIMOR-LESTE', 'TC', 'US', 'UM', 'VG', 'VIRGIN ISLANDS (US)'), 'numcode' => 840, 'precision' => 2),
