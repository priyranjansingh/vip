...
class Am_Controller_CreditCard_AuthorizeNet extends Am_Controller
{
    ...
    {
        $this->view->content .= "<b><span class='error'>".$msg."</div></b>";
        $url = $this->_request->getRequestUri();
        $url .= (strchr($url, '?') ? '&' : '?') . 'id=' . $this->_request->get('id');
        $url = Am_Controller::escape($url);
        $this->view->content .= " <b><a href='$url'>".___('Return and try again')."</a></b>";
...
jQuery(function () {
	...
	AuthorizeNetPopup.onReceiveCommunication = function (querystr) {
		...
		switch(params["action"]) {
			case "successfulSave":
                jQuery("#AuthorizeNetPopupInner").dialog("close");
    ...
    jQuery("#AuthorizeNetPopupInner").dialog({
        modal: true,
        autoOpen: true,
        closeOnEscape: false,
        draggable: false,    
