    <div class="col-xs-6 col-sm-4 col-md-3 col-lg-2">
        <div class="item">
            <div class="pos-rlt">
                    ...
                    <div class="center text-center m-t-n"> 
                        <?php if ($this->myauth->isLogin()) : ?>
                            <a href="javascript:void(null);#">
                                <i id="<?php echo $val['slug'] ?>" class="fa fa-play-circle play i-2x">
                                </i>
                            </a> 
                        <?php else : ?>
                            <a href="#" title="Login"> 
                ...
                <a href="#">
                    ...
                    if(!empty($val['thumbnail'])){
                        $src = "assets/thumbnail/songs/".$val['thumbnail'];
                    } else {
            ...
            <div class="padder-v"> <a href="#" class="text-ellipsis"> <?php echo $val['songName']   ?></a>
            </div>
        </div>
    </div>
